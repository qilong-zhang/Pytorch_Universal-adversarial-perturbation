...
I tested our code for `googlenet` , and with `epsilon=10` (`L_\infinity`), our accuracy on the validation set was ~78%.  It is similar with the result report in paper.
